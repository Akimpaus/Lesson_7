/****************************************************************************
** Meta object code from reading C++ file 'drawitem.h'
**
...
#error "The header file 'drawitem.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DrawItem_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_DrawItem_t qt_meta_stringdata_DrawItem = {
    {
QT_MOC_LITERAL(0, 8) // "DrawItem"
...
const QMetaObject DrawItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_DrawItem.offsetsAndSize,
    qt_meta_data_DrawItem,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_DrawItem_t
, QtPrivate::TypeAndForceComplete<DrawItem, std::true_type>
